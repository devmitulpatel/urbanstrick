...
onMounted(()=>{
   ...
   msHelper().auth().login(props.auth.user)
   msHelper().auth().setRawWished(props.auth.wished)
...
const toggleCart=()=>{
    cartModalOpen.value=(cartModalOpen.value)?false:true;
}
...
<template>
    ...
    <div>
        <CartModal v-model="cartModalOpen" ></CartModal>
                ...
                <div class="header-wrapper">
                    ...
                    <div class="menu-cart">
                                        ...
                                        <div v-if="false" class="mega-menu menu-minus">
                                            ...
                                            <div class="tas2">
                                                <div class=" menu-img ist">
                                                    <a  href="#"><img alt="" :src="asset('img/banner/bg_menu1.jpg')"></a>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                        ...
                        <div class="menu-sidebar-container">
                            <div v-if="false" class="tb-menu-sidebar floatleft">
                            ...
                            <div v-if="false" class="tb-menu-canvas-wrap floatleft">
                            ...
                            <div class="top-cart-wrapper wrap floatleft" v-if="msHelper().auth().check()">
                                <div class="top-shop-contain">
                                    <div class="block-shop">
                                        <div class="top-user-title " style="box-sizing: border-box;cursor: pointer" v-on:click.prevent="toggleProfile" >
                                            <a href="#">
                                                <i class="fa fa-user text-white"></i>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="user-popup margin" v-if="false"  >
                                        <div class="card py-4">
                                            ...
                                            <div class="mt-3 text-center">
                                                <h4 class="mb-0">{{ [msHelper().auth().user().first_name,msHelper().auth().user().last_name].join(' ') }}</h4>
                                ...
                                <div class="top-shop-contain">
                                    <div class="block-shop">
                                        <div class="top-shop-title">
                                            <a href="#" v-on:click.prevent="toggleCart">
                                                <i class="fa fa-shopping-cart"></i>
                                                <span class="count co1">{{ currentCart.getItemNo() }}</span>
                                            </a>
                                        </div>
                                        <div class="wish-cart margin pr-2" v-if="false">
                            ...
                            <div class="first-footer res-mrg-top-md rspn">
                                ...
                                <div class="textwidget">
                                    <ul class="f-none">
                                        ...
                                        <li><InertiaLink :href="route('about-us')">About us</InertiaLink></li>
        ...
        <ProfileModal v-model:is-show="profileModalOpen"></ProfileModal>
