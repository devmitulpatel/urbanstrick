...
<!--
Theme Name: starter-Responsive-Coming-Soon-Template
...
<head>
    ...
    <!--[if lt IE 9]>
        ...
        <![endif]-->
    <title>webthemez - starter-Responsive-Coming-Soon-Template</title>
    ...
    <div class="banner-container">
        <div class="container">
            ...
            <div class="heading text-center">
                <h2>Selling Clothes is not our specialty
                </h2>
                <strong>But happiness is !
                </strong> </div>
...
<section class="copyright" style="display: none">
    <div class="container">
        <div class="row">
            <div class="col-sm-12 text-center"> Copyright 2019 | All Rights Reserved -  by UrbanStrick </div>
        </div>
        <!-- / .row -->
    </div>
</section>
