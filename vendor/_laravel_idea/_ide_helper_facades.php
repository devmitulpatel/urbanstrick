...
namespace App\Facades {
    ...
    /**
     * @see \App\Repositories\ModelRepositories::all
     * @method static mixed all()
     * @see \App\Repositories\ModelRepositories::getRawData
     * @method static array|mixed getRawData($key = null)
     * @see \App\Repositories\ModelRepositories::uniqueColumn
     * @method static mixed|\Ramsey\Uuid\UuidInterface uniqueColumn($columnName, $value)
     * @see \App\Repositories\ModelRepositories::setModel
     * @method static void setModel(string $model)
     * @see \App\Repositories\ModelRepositories::query
     * @method static mixed query()
     * @see \App\Repositories\ModelRepositories::getModel
     * @method static string getModel()
     * @see \App\Repositories\ProductRepository::update
     * @method static null update($model, array $data)
     * @see \App\Repositories\ModelRepositories::getRow
     * @method static null getRow()
     * @see \App\Repositories\ProductRepository::delete
     * @method static void delete($model)
     * @see \App\Repositories\ProductRepository::create
     * @method static \App\Models\Product create(array $data)
     * @see \App\Repositories\ModelRepositories::setRow
     * @method static void setRow(null $row)
     * @see \App\Repositories\ModelRepositories::setRawData
     * @method static void setRawData(array $rawData)
     */
    class Product {}
     ...
     * @see \App\Repositories\ModelRepositories::getModel
     * @method static string getModel()
     * @see \App\Repositories\UnitRepository::update
     * @method static void update($model, array $data)
     * @see \App\Repositories\ModelRepositories::getRow
     * @method static null getRow()
     * @see \App\Repositories\UnitRepository::delete
     * @method static void delete($model)
     * @see \App\Repositories\UnitRepository::create
     * @method static null create(array $data)
     * @see \App\Repositories\ModelRepositories::setRow
     * @method static void setRow(null $row)
     * @see \App\Repositories\ModelRepositories::setRawData
     * @method static void setRawData(array $rawData)
...
namespace Plank\Mediable\Facades {
    ...
    /**
     * @see \Plank\Mediable\ImageManipulator::getVariantDefinition
     * @method static \Plank\Mediable\ImageManipulation getVariantDefinition(string $variantName)
     * @see \Plank\Mediable\ImageManipulator::defineVariant
     * @method static void defineVariant(string $variantName, \Plank\Mediable\ImageManipulation $manipulation)
     * @see \Plank\Mediable\ImageManipulator::validateMedia
     * @method static void validateMedia(\Plank\Mediable\Media $media)
     * @see \Plank\Mediable\ImageManipulator::hasVariantDefinition
     * @method static bool hasVariantDefinition(string $variantName)
     * @see \Plank\Mediable\ImageManipulator::determineFilename
     * @method static string determineFilename(\Plank\Mediable\Media $originalMedia, \Plank\Mediable\ImageManipulation $manipulation, \Plank\Mediable\Media $variant, \Psr\Http\Message\StreamInterface $stream)
     * @see \Plank\Mediable\ImageManipulator::createImageVariant
     * @method static \Plank\Mediable\Media createImageVariant(\Plank\Mediable\Media $media, string $variantName, bool $forceRecreate = false)
     */
...
namespace {
    ...
    class Product extends App\Resource\ProductFacade {}
